...
var BinfoMenu = function (element, options) {
...
BinfoMenu.prototype = {
    ...
    _renderItem: function (item) {
        ...
        var s = '<li class="' + (hasChildren ? 'has-children open' : '') + '">';        //class="menu-item" open, expanded?
        ...
        s += '<span class="menu-text">' + item.resName + '</span>';
